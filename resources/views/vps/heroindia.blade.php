<section class="relative bg-gradient-to-br from-[#dff6fd] to-[#f7fafe] min-h-[440px] overflow-hidden py-8 sm:py-0">
        ...
        <div class="relative w-full h-full flex items-center">
            <div class="w-full h-full flex items-center">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="flex flex-col justify-center space-y-5 text-center lg:text-left order-2 lg:order-1">
                        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight text-[#0a2540]">
                            VPS Hosting - India
                        </h1>
