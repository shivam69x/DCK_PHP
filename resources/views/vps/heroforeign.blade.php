<section class="relative bg-gradient-to-br from-[#dff6fd] to-[#f7fafe] min-h-[440px] overflow-hidden">
    <div class="container mx-auto px-4 sm:px-6 h-full relative">
        {{-- Carousel Container --}}
        <div class="relative w-full h-full flex items-center py-8 sm:py-0">
            <div class="w-full h-full flex items-center">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="flex flex-col justify-center space-y-5 order-2 lg:order-1 text-center lg:text-left">
                        ...
                        {{-- CTA Buttons --}}
                        <div class="pt-2">
                            <a href="{{ url('/vpsforeign/planforeign') }}"
