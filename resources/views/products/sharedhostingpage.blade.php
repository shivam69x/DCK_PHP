...
@section('content')
            ...
            <div class="grid lg:grid-cols-2 gap-6 items-center">
                ...
                <div class="relative flex justify-center lg:justify-center sm:bottom-[20px] md:bottom-[50px] bottom-[110px]">
                    ...
                    <div class="relative -bottom-[100px] lg:bottom-[0px]">
                        {{-- Background Circle --}}
                        <img class="animate-float w-[600px]" src="{{ asset('assets/sh08.png') }}" alt="Shared Hosting Image" />
    ...
    @include('products.shplans')
    @include('products.shfeatures')
