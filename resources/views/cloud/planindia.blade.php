...
@section('content')
    <section class="min-h-screen py-16 px-4 sm:px-6 lg:px-0">
                ...
                <template x-for="(plan, index) in {{ json_encode($currentPlans) }}" :key="index">
                    ...
                    >
                        ...
                        <div class="p-8">
                            ...
                            {{-- CTA Button --}}
                            <button
                                @click="window.location.href = '{{ url('/billing') }}?plan=' + encodeURIComponent(JSON.stringify({...plan, category: 'Cloud-India Hosting', type: 'monthly'}))"
                                :class="plan.popular
