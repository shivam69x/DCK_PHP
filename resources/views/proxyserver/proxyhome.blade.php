...
@section('content')
    <div class="min-h-[65vh] bg-gradient-to-br from-[#dff6fd] to-[#f7fafe] relative overflow-hidden">
        ...
        {{-- Main Content --}}
        <div class="container mx-auto px-4 py-4 lg:py-14 relative z-10">
            <div class="grid lg:grid-cols-2 gap-6 items-center">
                ...
                <div class="text-center lg:text-left space-y-8">
                    <div class="space-y-4">
                        <h1 class="text-2xl md:text-3xl lg:text-[55px] font-bold text-[#0e3c47] leading-tight flex flex-col gap-2">
                            ...
                            <span class="relative inline-block">
                                <span class="mt-4 bg-[#19849f] text-white px-4 py-2 rounded-lg transform -rotate-2 inline-block shadow-lg text-2xl">
                                    5% OFF
                                </span>
                            </span>
                        </h1>
                    ...
                    {{-- CTA Button --}}
                    <div class="pt-0">
                        <a href="{{ url('/proxyserver/proxyplans') }}"
                ...
                {{-- Right Side - Visual --}}
                <div class="relative flex justify-center bottom-[60px] sm:bottom-[40px] md:bottom-[20px] lg:bottom-0">
                    {{-- Main Cloud Server Icon --}}
                    <div class="relative">
                        {{-- Background Circle --}}
                        <img
                            class="w-[300px] sm:w-[400px] md:w-[600px] lg:w-[800px] animate-float"
                            src="{{ asset('assets/proxy011.png') }}"
                            alt="Cloud Server"
                        />

                        {{-- Floating Elements --}}
                        <div class="absolute top-2 left-2 sm:top-4 sm:-left-3 bg-white/40 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-slate-300/50 animate-float">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 sm:w-6 sm:h-6 text-slate-700"><rect width="20" height="14" x="2" y="8" rx="2" ry="2"/><path d="M6 15h0.01"/><path d="M10 15h0.01"/><path d="M14 15h0.01"/><path d="M18 15h0.01"/><path d="M6 11h0.01"/><path d="M10 11h0.01"/><path d="M14 11h0.01"/><path d="M18 11h0.01"/><path d="M2 17h20"/><path d="M2 17V8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v9"/><path d="M2 17h20"/></svg>
                        </div>

                        <div class="absolute bottom-3 right-2 sm:bottom-6 sm:-right-1 bg-white/40 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-slate-300/50 animate-float delay-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 sm:w-6 sm:h-6 text-slate-700"><path d="M17.5 19H18a4 4 0 0 0 0-8h-.5A2.5 2.5 0 0 1 15 9.5a2.5 2.5 0 0 1 .4-1.2l.7-.7A3.5 3.5 0 0 0 12 4.5 3.5 3.5 0 0 0 7.5 7H7a4 4 0 0 0-4 4 4 4 0 0 0 .5 8H5"/></svg>
                        </div>

                        <div class="absolute top-1/2 right-0 sm:-right-5 bg-white/40 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-slate-300/50 animate-float delay-700">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 sm:w-6 sm:h-6 text-slate-700"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('proxyserver.proxypricetable')
    @include('proxyserver.proxyfeatures')
    {{-- @include('proxyserver.proxyplans') --}}
